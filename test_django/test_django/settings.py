...
SECRET_KEY = '05gon(yh+sax)hllf5xa*m2(=exj8pw5$q*jxnq6ggf6qefjr&'
...
MIDDLEWARE = [
    ...
    'test_django.middleware.LoginRequiredMiddleware',
]
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'test_django/media')

LOGIN_REDIRECT_URL = '/app_one/'
